    ...
    <div id="primary" class="content-area">
        <!-- <main id="main" class="site-main">
            ...
            <section class="services">
                <div class="info-box">
                    <span><?php esc_html_e('We care about', 'wp-boiler') ?></span>
                    <p><span id="emphasis"><?php esc_html_e('your job.', 'wp-boiler') ?></span></p>
                    <p><?php esc_html_e('Friendly and attentive service with over 30 years of experience.', 'wp-boiler') ?></p>
                    <button><?php esc_html_e('Learn About Our Services', 'wp-boiler') ?></button>
                </div>
            ...
            <section class="about-us">
                ...
                <div class="about-info">
                        ...
                        <p><?php echo nl2br(esc_html($about_subtitle)); ?></p>
                </div>
            </section>
            <div class="gradient-bottom"></div>
            <section class="home-blog">
                <h2><?php _e('Latest News', 'wp-boiler') ?></h2>
                <div class="container">
                    <?php
